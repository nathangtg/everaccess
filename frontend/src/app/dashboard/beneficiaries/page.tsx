                ...
                <div className="flex items-center mb-6 relative z-10">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-1.5">
                      <span className={`inline-block px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide rounded-full
                        ${isCharity ? 'bg-red-100 text-red-600' : 'bg-blue-100 text-blue-600'}
                      `}>
                        {person.relationship_type}
                      </span>
                      {!person.is_registered && (
                        <span className="inline-block px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide rounded-full bg-slate-100 text-slate-500 border border-slate-200">
                          Not Registered
                        </span>
                      )}
                    </div>
