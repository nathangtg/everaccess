      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-slate-200/50 p-8 md:p-10 border border-white/50">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 mt-3 text-lg">Access your secure digital vault</p>
          </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-slate-500 font-medium">
              Don&apos;t have a vault?{' '}
              <Link href="/register" className="text-blue-600 hover:text-blue-700 hover:underline decoration-2 underline-offset-4 transition-all">
                Create one now
              </Link>
            </p>
          </div>
